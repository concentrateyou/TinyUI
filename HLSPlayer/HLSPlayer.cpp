	...
	INT       nCmdShow)
{
	...
	TinyApplication::GetInstance()->Initialize(hInstance, lpCmdLine, nCmdShow, MAKEINTRESOURCE(IDC_HLSPLAYER));
	TinyMessageLoop theLoop;
	TinyApplication::GetInstance()->AddMessageLoop(&theLoop);

	QueryPerformanceFrequency(&g_clockFreq);

	HLSPlayer::MPreviewView uiImpl;
