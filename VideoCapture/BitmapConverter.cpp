...
namespace Media
{
	...
	//	if (auto_fill && src_width_ >= dst_width_ && src_height_ >= dst_height_) {
	...
	//	else {
	//		if (geometric) {
	//			get_centered_video_position(src_width_, src_height_, dst_width_, dst_height_, picture_x_, picture_y_, picture_width_, picture_height_);
	//			picture_width_ = (picture_width_ >> 3) << 3;
	//			picture_height_ = (picture_height_ >> 3) << 3;
	//			if (picture_x_ != 0) {
	...
	//			picture_x_ = 0;
	//			picture_y_ = 0;
	//			picture_width_ = dst_width_;
	//			picture_height_ = dst_height_;
	//		}
	//	}
	//	src_frame_ = av_frame_alloc();
	//	dst_frame_ = av_frame_alloc();
	//	temp_src_ = new uint8_t[src_width_* (src_height_ + 1) * 3];
	//	sws_context_ = sws_getContext(src_width_, src_height_, src_pixel_, picture_width_, picture_height_, dst_pixel_, SWS_BICUBIC, NULL, NULL, NULL);
	//}
	...
	//	{
	//		memcpy(temp_src_, src_buffer, src_height_*line_size_);
