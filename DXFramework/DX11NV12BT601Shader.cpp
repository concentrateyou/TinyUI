...
{
	DX11NV12BT601Shader::DX11NV12BT601Shader()
	{
	}
	...
	BOOL DX11NV12BT601Shader::Initialize(DX11& dx11, const CHAR* vsFile, const CHAR* psFile)
	{
		HRESULT hRes = S_OK;
	...
	void DX11NV12BT601Shader::Render(DX11& dx11)
	{
	...
	void DX11NV12BT601Shader::SetShaderParameters(DX11& dx11, const XMMATRIX& worldMatrix, const XMMATRIX& viewMatrix, const XMMATRIX& projectionMatrix, DX11Texture2D* textures[2])
	{
