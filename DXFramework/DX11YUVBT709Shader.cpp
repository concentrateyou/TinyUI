...
namespace DXFramework
{
	...
	BOOL DX11YUVBT709Shader::Initialize(DX11& dx11, const CHAR* vsFile, const CHAR* psFile)
	{
		...
		hRes = D3DX11CompileFromFile(vsFile, NULL, NULL, "YUVBT709VertexShader", "vs_4_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL, &vertexShaderBuffer, &errorMsg, NULL);
		if (hRes != S_OK)
		{
		...
		hRes = D3DX11CompileFromFile(psFile, NULL, NULL, "YUVBT709PixelShader", "ps_4_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL, &pixelShaderBuffer, &errorMsg, NULL);
		if (hRes != S_OK)
		{
			CHAR* error = (CHAR*)errorMsg->GetBufferPointer();
