...
{
	DX11YUVBT709Shader::DX11YUVBT709Shader()
	{
	}
	...
	BOOL DX11YUVBT709Shader::Initialize(DX11& dx11, const CHAR* vsFile, const CHAR* psFile)
	{
		HRESULT hRes = S_OK;
		...
		if (hRes != S_OK)
		{
			...
			LOG(ERROR) << "DX11TextureShader Initialize - YUVBT709VertexShader: " << error;
			return FALSE;
		}
		...
		{
			CHAR* error = (CHAR*)errorMsg->GetBufferPointer();
			LOG(ERROR) << "DX11TextureShader Initialize - YUVBT709PixelShader: " << error;
			return FALSE;
		}
	...
	void DX11YUVBT709Shader::Render(DX11& dx11)
	{
	...
	void DX11YUVBT709Shader::SetShaderParameters(DX11& dx11, const XMMATRIX& worldMatrix, const XMMATRIX& viewMatrix, const XMMATRIX& projectionMatrix, DX11Texture2D* textures[2])
	{
