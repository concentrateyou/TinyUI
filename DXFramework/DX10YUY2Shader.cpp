#include "stdafx.h"
#include "DX10YUY2Shader.h"

namespace DXFramework
{
	DX10YUY2Shader::DX10YUY2Shader()
	{
	}
	...
	BOOL DX10YUY2Shader::Initialize(DX10& dx10, const CHAR* vsFile, const CHAR* psFile)
	{
		HRESULT hRes = S_OK;
	...
	void DX10YUY2Shader::Render(DX10& dx10)
	{
	...
	void DX10YUY2Shader::SetShaderParameters(DX10& dx10, const XMMATRIX& worldMatrix, const XMMATRIX& viewMatrix, const XMMATRIX& projectionMatrix, DX10Texture2D* textures[1])
	{
		...
		ID3D10ShaderResourceView* spv = textures[0]->GetSRView();
		ASSERT(spv);
