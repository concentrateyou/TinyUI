...
{
	DX11YUVBT601Shader::DX11YUVBT601Shader()
	{
	}
	...
	BOOL DX11YUVBT601Shader::Initialize(DX11& dx11, const CHAR* vsFile, const CHAR* psFile)
	{
		HRESULT hRes = S_OK;
	...
	void DX11YUVBT601Shader::Render(DX11& dx11)
	{
	...
	void DX11YUVBT601Shader::SetShaderParameters(DX11& dx11, const XMMATRIX& worldMatrix, const XMMATRIX& viewMatrix, const XMMATRIX& projectionMatrix, DX11Texture2D* textures[2])
	{
