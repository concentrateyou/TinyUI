...
namespace DXFramework
{
	...
	public:
		...
		BOOL Create(DX11& dx11, const TinySize& size, BYTE* bits, BOOL bReadonly);//IOø…∑√Œ Œ∆¿Ì
		BOOL Create(DX11& dx11, const TinySize& size, BOOL bShared);
		...
		BOOL Copy(DX11& dx11, const BYTE* bits, LONG size, INT linesize);
