...
namespace DXFramework
{
	...
	FLOAT DX11Image2D::GetRotate() const
	{
		return m_angle;
	}
	XMFLOAT2 DX11Image2D::GetSize() const
	{
		return m_size;
	}
	XMFLOAT2 DX11Image2D::GetScale() const
	{
		return m_scale;
	}
	XMFLOAT2 DX11Image2D::GetTranslate() const
	{
		return m_translate;
	}
	BOOL DX11Image2D::IsFlipH() const
	{
		return m_bFlipH;
	}
	BOOL DX11Image2D::IsFlipV() const
	{
		return m_bFlipV;
	}
	void DX11Image2D::SetSize(const XMFLOAT2& size)
	{
		m_size = size;
	}
	void DX11Image2D::SetRotate(FLOAT angle)
	{
		m_angle = angle;
	}
	void DX11Image2D::SetScale(const XMFLOAT2& scale)
	{
		m_scale = scale;
	}
	void DX11Image2D::SetTranslate(const XMFLOAT2& pos)
	{
		m_translate = pos;
	}
	void DX11Image2D::SetFlipH(BOOL bFlag)
	{
		m_bFlipH = bFlag;
	}
	void DX11Image2D::SetFlipV(BOOL bFlag)
	{
		m_bFlipV = bFlag;
	}
