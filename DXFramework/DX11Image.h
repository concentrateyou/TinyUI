...
namespace DXFramework
{
	...
	public:
		...
		BOOL BitBlt(const DX11& dx11, HBITMAP hBitmap, const TinyRectangle& dst, const TinyPoint& src);
		BOOL BitBlt(const DX11& dx11, HDC hsrc, const TinyRectangle& dst, const TinyPoint& src);
