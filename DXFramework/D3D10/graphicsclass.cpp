...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	m_Bitmap->Initialize(m_D3D->GetDevice(), screenWidth, screenHeight, "D:\\test1.png", 407, 229);
	...
	if (pTexture)
	{
	result = m_Bitmap->Initialize(m_D3D->GetDevice(), screenWidth, screenHeight, pTexture->TextureHandle, 256, 256);
	if (!result)
	{
