...
namespace TinyUI
{
	namespace Media
	{
		TinyMFTMP3Decode::TinyMFTMP3Decode()
		{
		}
		TinyMFTMP3Decode::~TinyMFTMP3Decode()
		{
		...
		BOOL TinyMFTMP3Decode::Open(const WAVEFORMATEX* pFMT, DWORD dwSampleRate, Callback<void(BYTE*, LONG, LPVOID)>&& callback)
		{
			HRESULT hRes = S_OK;
