...
namespace TinyUI
{
	extern "C"
	{
		static CLSID CLSID_FileOpenDialog = { 0xDC1C5A9C, 0xE88A, 0x4DDE,{ 0xA5, 0xA1, 0x60, 0xF8, 0x2A, 0x20, 0xAE, 0xF7 } };
		static CLSID CLSID_FileSaveDialog = { 0xC0B4E2F3, 0xBA21, 0x4773,{ 0x8D, 0xBA, 0x33, 0x5E, 0xC9, 0x46, 0xEB, 0x8B } };
