...
namespace TinyUI
{
	...
	{
		IMPLEMENT_DYNCREATE(TinyVisualAnimate, TinyVisual);
		
		TinyVisualAnimate::TinyVisualAnimate()
		{

		}
		TinyVisualAnimate::TinyVisualAnimate(TinyVisual* spvisParent, TinyVisualDocument* vtree)
		...
		TinyString TinyVisualAnimate::RetrieveTag() const
		{
			return TinyVisualTag::LABEL;
		}

		BOOL TinyVisualAnimate::OnDraw(HDC hDC, const RECT& rcPaint)
		{
