...
namespace TinyUI
{
	namespace Windowless
	{
		...
		LRESULT TinyVisualHWND::OnMouseMove(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
		{
			...
			return m_document->OnMouseMove(pos, static_cast<DWORD>(wParam));
		}
