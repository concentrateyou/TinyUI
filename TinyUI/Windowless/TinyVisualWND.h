...
namespace TinyUI
{
	namespace Windowless
	{
		...
		/// 无窗口基类
		/// </summary>
		class TinyVisualHWND : public TinyHandleHWND
		{
		...
		private:
			...
			static INT_PTR CALLBACK BeginLoopDLG(HWND hWND, UINT uMsg, WPARAM wParam, LPARAM lParam);
			static INT_PTR CALLBACK EndLoopDLG(HWND hWND, UINT uMsg, WPARAM wParam, LPARAM lParam);
		...
		protected:
			...
			LPVOID			m_hPrimaryProc;//原始的PROC
		};
		/// <summary>
		/// 无窗口类
		/// </summary>
		class TinyVisualWND : public TinyVisualHWND
		{
			DECLARE_DYNAMIC(TinyVisualWND)
		public:
			TinyVisualWND();
			virtual ~TinyVisualWND();
		...
		public:
			...
			void	SetDefaultFont();
		public:
			BEGIN_MSG_MAP(TinyVisualWND, TinyVisualHWND)
